...
const bushColorTexture = textureLoader.load('/textures/bushes/color.jpg')
...
for (let i = 0; i < 50; i++) {
  ...
  const z = Math.sin(angle) * radius; // Get the z position using sinnus
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#5f0900', 2, 2)
scene.add(ghost1)

const ghost2 = new THREE.PointLight('#618160', 2, 3)
scene.add(ghost2)

const ghost3 = new THREE.PointLight('#130651', 2, 3)
scene.add(ghost3)
